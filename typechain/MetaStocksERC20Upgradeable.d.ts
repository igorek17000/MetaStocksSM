...
interface MetaStocksERC20UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class MetaStocksERC20Upgradeable extends BaseContract {
  ...
  interface: MetaStocksERC20UpgradeableInterface;

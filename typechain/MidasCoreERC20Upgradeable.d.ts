...
interface MidasCoreERC20UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class MidasCoreERC20Upgradeable extends BaseContract {
  ...
  interface: MidasCoreERC20UpgradeableInterface;

...
interface IDexRouterManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class IDexRouterManager extends BaseContract {
  ...
  interface: IDexRouterManagerInterface;

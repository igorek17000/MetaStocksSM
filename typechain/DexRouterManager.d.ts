...
interface DexRouterManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class DexRouterManager extends BaseContract {
  ...
  interface: DexRouterManagerInterface;

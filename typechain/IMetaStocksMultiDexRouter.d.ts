...
interface IMetaStocksMultiDexRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class IMetaStocksMultiDexRouter extends BaseContract {
  ...
  interface: IMetaStocksMultiDexRouterInterface;
